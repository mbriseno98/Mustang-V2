...
function addContact() {
    ...
    contactList.push(contactAdd.firstName)
    contactArray.push(contactAdd);
...
function remove() {
    if(contactArray.length > 1){
        ...
        document.getElementById("warning").innerHTML = "You must have one contact!"
        console.log("You must have one contact!")
    }
...
// auto-fills the state/city with php/zip
function autoFill() {
...
//--------------------Taken from Vincent's Mustang Version 2 -------------------------------------
